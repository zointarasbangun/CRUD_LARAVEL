        ...
        <div class="card-body">
            <form method="POST" action="{{ url('students') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text"
                            class="form-control form-control-sm @error('txtfullname') is-invalid @enderror" id="txtfullname"
                            name="txtfullname" value="{{ old('txtfullname') }}">
                        @error('txtfullname')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select class="form-select form-select-sm @error('txtgender') is-invalid @enderror"
                                name="txtgender" id="txtgender" value="{{ old('txtgender') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="txtemail" id="txtemail"
                                class="form-control form-control-sm @error('txtemail') is-invalid @enderror">
                            @error('txtemail')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="txtphone" id="txtphone"
                                class="form-control form-control-sm @error('txtphone') is-invalid @enderror">
                            @error('txtphone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <button type="submit" class="btn btn-sm btn-success @error('') is-invalid @enderror">
                                Save
                            </button>
                        </div>
                    </div>
